...
namespace System.Data.Entity.Spatial
{
  ...
  public class DbGeography
  {
    ...
    public static DbGeography GeographyCollectionFromBinary(
      ...
      int coordinateSystemId)
    {
      Check.NotNull<byte[]>(geographyCollectionWellKnownBinary, nameof (geographyCollectionWellKnownBinary));
    ...
    public static DbGeography GeographyCollectionFromText(
      ...
      int coordinateSystemId)
    {
      Check.NotNull<string>(geographyCollectionWellKnownText, nameof (geographyCollectionWellKnownText));
    ...
    {
      Check.NotNull<DbGeography>(other, nameof (other));
