  ...
  internal static class TypeExtensions
  {
    ...
    public static T CreateInstance<T>(this Type type, Func<string, Exception> exceptionFactory = null)
    {
      ...
      if (type.GetDeclaredConstructor() == (ConstructorInfo) null)
        throw exceptionFactory(Strings.CreateInstance_NoParameterlessConstructor((object) type));
      if (type.IsAbstract())
        throw exceptionFactory(Strings.CreateInstance_AbstractType((object) type));
      if (type.IsGenericType())
        throw exceptionFactory(Strings.CreateInstance_GenericType((object) type));
